...
class BasicAssertionsTest {
    ...
    fun testAssertEqualsDouble() {
        ...
        // NaN
        val nans = doubleArrayOf(Double.NaN, Double.fromBits(0xFFF80000L shl 32), Double.fromBits(Double.NaN.toBits() or 1))
        for (nan1 in nans) {
    ...
    fun testAssertEqualsDoubleFails() {
        ...
        checkFailedAssertion { assertEquals(0.01, 1.03, -5.0) }
    ...
    fun testAssertEqualsFloat() {
        ...
        // NaN
        val nans = floatArrayOf(Float.NaN, Float.fromBits(0xFFFC0000.toInt()), Float.fromBits(Float.NaN.toBits() or 1))
        for (nan1 in nans) {
            assertTrue(nan1.isNaN())
            for (nan2 in nans) {
    ...
    fun testAssertEqualsFloatFails() {
        ...
        // negative absoluteTolerance
        checkFailedAssertion { assertEquals(0.01f, 1.03f, -5.0f) }
    }
    ...
    fun testAssertNotEqualsDoubleFails() {
        ...
        // negative absoluteTolerance
        checkFailedAssertion { assertNotEquals(0.1, 0.11, -0.001) }
    }
    ...
    fun testAssertNotEqualsFloatFails() {
        ...
        // negative absoluteTolerance
        checkFailedAssertion { assertNotEquals(0.1f, 0.11f, -0.001f) }
    }
