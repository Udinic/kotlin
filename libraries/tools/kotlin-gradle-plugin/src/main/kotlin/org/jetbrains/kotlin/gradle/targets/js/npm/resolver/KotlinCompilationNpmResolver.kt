...
//    val packageJsonProducer
//        get() = if (compilation != null) {
//            packageJsonProducerProvider.get().also {
//                it.internalDependencies.forEach { it.rootResolver = rootResolver }
//                it.project = project
//                it.npmProject = npmProject
//            }
//        } else {
//            rootResolver.getPackageJsonProducer(projectPath, compilationDisambiguatedName)
//        }
...
//        fun toPackageJsonProducer(): Provider<PackageJsonProducer> {
//            return project.gradle.sharedServices.registerIfAbsent(
//                "package-json-producer-${project.path}-${compilation.disambiguatedName}",
//                PackageJsonProducer::class.java
//            ) { producer ->
//                producer.parameters.internalDependencies.set(internalDependencies)
//                producer.parameters.internalCompositeDependencies.set(internalCompositeDependencies)
//                producer.parameters.externalGradleDependencies.set(externalGradleDependencies.map {
...
//                    )
//                })
//                producer.parameters.externalNpmDependencies.set(externalNpmDependencies.map { it.toDeclaration() })
//                producer.parameters.fileCollectionDependencies.set(fileCollectionDependencies)
//                producer.parameters.npmProject.set(npmProject)
//                producer.parameters.projectPackagesDir.set(nodeJs.projectPackagesDir)
//                producer.parameters.rootProjectDir.set(nodeJs.rootProject.rootDir)
//                producer.parameters.gradleNodeModules.set(rootResolver.gradleNodeModules)
//                producer.parameters.compositeNodeModules.set(rootResolver.compositeNodeModules)
//                producer.parameters.packageJsonHandlers.set(compilation.packageJsonHandlers)
//                producer.parameters.taskRequirements.set(nodeJs.taskRequirements)
//                producer.parameters.npmVersion.set(npmVersion)
//                producer.parameters.compilationDisambiguatedName.set(compilationDisambiguatedName)
//            }
//        }
